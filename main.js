...
const loadSong = (index) => {
  ...
  audio.src = `media/${songData[index].src}`;
};
...
const playSong = () => {
  ...
  // فعال کردن انیمیشن موج
  songProgress.classList.add("wave-animation");
};
...
const pauseSong = () => {
  ...
  // غیرفعال کردن انیمیشن موج
  songProgress.classList.remove("wave-animation");
};
